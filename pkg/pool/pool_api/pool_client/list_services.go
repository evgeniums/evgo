...
func (a *ListServices) Exec(client api_client.Client, sctx context.Context, operation api.Operation) error {
...
func (p *PoolClient) GetServices(sctx context.Context, filter *db.Filter) ([]*pool.PoolServiceBase, int64, error) {
	...
	err = handler.Exec(p.Client(), sctx, p.list_services)
	if err != nil {
